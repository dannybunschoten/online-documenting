...
export default function Basisstation({
  basisstationChecklist,
}: {
  ...
  return (
    <section
      ...
      id={titleToId("0300 - Basisstation (grondkooi)")}
    >
      <Card className="shadow-lg border-0 bg-gradient-to-br from-white to-gray-50/50 overflow-hidden py-0 gap-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-2xl font-bold tracking-tight text-white">
                0300 - Basisstation (grondkooi)
              </CardTitle>
              <CardDescription className="text-white/80 mt-1 font-medium">
                Resultaten van de basisstation inspectie
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="p-0">
          <ResultTable
            tableData={basisstationChecklist}
